...
var RemoteCursorManager = /*#__PURE__*/function () {
  ...
  _createClass(RemoteCursorManager, [{
    ...
    value: function addCursor(id, color, label) {
      ...
      var cursorWidget = new _RemoteCursorWidget.RemoteCursorWidget(this._options.editor, widgetId, this._options.className, color, label, this._options.tooltips, tooltipDurationMs, this._options.showTooltipOnHover, this._options.tooltipClassName, function () {
